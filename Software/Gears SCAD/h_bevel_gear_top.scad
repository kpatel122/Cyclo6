...
hub = true;
hub_diameter = 6; // 0.01
hub_thickness = 1   ; // 0.01

mount_hole_size = 4.5;
mount_hole_distnce = 15;
    ...
    difference(){
        ...
        */
        ...
        for (a =[0:3])
        {
            ...
            cylinder(h = 1+6, r =            mount_hole_size/2);
        }
...
//KP helix_angle=-finalHelixAngle for reverse bevel
finalHelixAngle =-finalHelixAngle;
