...
#define cpu_map_h
  ...
  #define STEP_PORT_0 A//F
  #define STEP_PORT_1 C//F
  #define STEP_PORT_2 C//L
  #if N_AXIS > 3
    #define STEP_PORT_3 D // Axis number 4 (Ramps E0)
  #endif
  #if N_AXIS > 4
  ...
  #endif
  #define STEP_BIT_0 3 //A3:Figital pin 25   //0  // X Step - Pin A0
  #define STEP_BIT_1 6 //C6 digital pin 31    //6  // Y Step - Pin A6
  #define STEP_BIT_2 0 //C0 dp 37 // Z Step - Pin D46
  #if N_AXIS > 3
    #define STEP_BIT_3  1  //D1 dp 20 // Axis number 4 Step - Pin D26
  #endif
  #if N_AXIS > 4
    #define STEP_BIT_4 6 //L6 dp 43     Axis number 5 Step - Pin D36
  #endif
  #if N_AXIS > 5
    #define STEP_BIT_5 0  //L1 dp 49 // Axis number 6 Step - Pin D49
  #endif
  ...
  #define DIRECTION_PORT_1 C//F
  #define DIRECTION_PORT_2 G //L
  #if N_AXIS > 3
    #define DIRECTION_PORT_3  D //A // Axis number 4 (Ramps E0)
  #endif
  #if N_AXIS > 4
    #define DIRECTION_PORT_4 L // Axis number 5 (Ramps E1)
  #endif
  #if N_AXIS > 5
    #define DIRECTION_PORT_5 L //L2 // Axis number 6 (Ramps Aux-3 D51)
  #endif
  #define DIRECTION_BIT_0 1//PA1:Digital pin 23 //1 // X Dir - Pin A1
  #define DIRECTION_BIT_1 4//C4 Digital pin 33 //7 // Y Dir - Pin A7
  #define DIRECTION_BIT_2 2 //G2 dp 39// Z Dir - Pin D48
  #if N_AXIS > 3
    #define DIRECTION_BIT_3  0//D0 dp 21   // Axis number 4 Step - Pin D28
  #endif
  #if N_AXIS > 4
    #define DIRECTION_BIT_4 4 //L4 dp 45   Axis number 5 Step - Pin D34
  #endif
  #if N_AXIS > 5
    #define DIRECTION_BIT_5 2 // L2 dp 47 // Axis number 6 Step - Pin D51
  #endif
  ...
  #if N_AXIS > 3
    #define STEPPER_DISABLE_PORT_3  D //A // Axis number 4 (Ramps E0)
  #endif
  #if N_AXIS > 4
    #define STEPPER_DISABLE_PORT_4 G // Axis number 5 (Ramps E1)
  #endif
  #if N_AXIS > 5
    #define STEPPER_DISABLE_PORT_5 L // Axis number 5 (Ramps Aux-3 D53)
  #endif
  #define STEPPER_DISABLE_BIT_0 5 //PA5 digital pin 27   //7 // X Enable - Pin D38
  #define STEPPER_DISABLE_BIT_1 4 //A4 digital pin 26 //2 // Y Enable - Pin A2
  #define STEPPER_DISABLE_BIT_2 2 //C2 dp 35     0 // Z Enable - Pin A8
  #if N_AXIS > 3
    #define STEPPER_DISABLE_BIT_3 2 //D2 dp 19      //2 // Axis number 4 Step - Pin D24
  #endif
  #if N_AXIS > 4
    #define STEPPER_DISABLE_BIT_4 0 //G0 dp 41 Axis number 5 Step - Pin D30
  #endif
  #if N_AXIS > 5
    #define STEPPER_DISABLE_BIT_5 1 //L1 dp 48     // Axis number 5 Step - Pin D53
  #endif
  ...
  #endif
  #define MIN_LIMIT_BIT_0 0 //A0 digital pin 22 //5 // X Limit Min - Pin D3
  #define MIN_LIMIT_BIT_1 4 //A4 digital pin 26 //1 // Y Limit Min - Pin D14
  #define MIN_LIMIT_BIT_2 7 //C7 dp 30               //3 // Z Limit Min - Pin D18
  #if N_AXIS > 3
    #define MIN_LIMIT_BIT_3 2 //A2 DP 24       Axis number 4 : RAMPS AUX2 pin D42
  #endif
  #if N_AXIS > 4
    #define MIN_LIMIT_BIT_4 6 //A6  // Axis number 5 : RAMPS AUX2 pin D44
  #endif
  #if N_AXIS > 5
    #define MIN_LIMIT_BIT_5 5 //C5 dp 32 //3 // Axis number 6 : RAMPS AUX2 pin D57
  #endif
  ...
  #define MAX_LIMIT_PORT_0 MIN_LIMIT_PORT_0
  #define MAX_LIMIT_PORT_1 MIN_LIMIT_PORT_1
  #define MAX_LIMIT_PORT_2 MIN_LIMIT_PORT_2
  #if N_AXIS > 3
    #define MAX_LIMIT_PORT_3 MIN_LIMIT_PORT_3
  #endif
  #if N_AXIS > 4
    #define MAX_LIMIT_PORT_4 MIN_LIMIT_PORT_4
  #endif
  #if N_AXIS > 5
    #define MAX_LIMIT_PORT_5 MIN_LIMIT_PORT_5 // (Ramps Aux-3 D58)
  #endif
  #define MAX_LIMIT_BIT_0 MIN_LIMIT_BIT_0 // X Limit Max - Pin D2
  #define MAX_LIMIT_BIT_1 MIN_LIMIT_BIT_1 // Y Limit Max - Pin D15
  #define MAX_LIMIT_BIT_2 MIN_LIMIT_BIT_2 // Z Limit Max - Pin D18
  #if N_AXIS > 3
    #define MAX_LIMIT_BIT_3 MIN_LIMIT_BIT_3 // Axis number 4 : RAMPS AUX2 pin D40
  #endif
  #if N_AXIS > 4
    #define MAX_LIMIT_BIT_4 MIN_LIMIT_BIT_4 // Axis number 5 : RAMPS AUX2 pin D59
  #endif
  #if N_AXIS > 5
    #define MAX_LIMIT_BIT_5 MIN_LIMIT_BIT_5 // Axis number 6 : RAMPS AUX2 pin D58
  #endif
